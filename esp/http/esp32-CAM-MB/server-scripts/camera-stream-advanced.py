...
def video_stream():
    try:
        ...
        socketio.emit('frame_update', {'camera_id': camera_id, f'status-{camera_id}': 'Person Detected' if cur_camera_seen_person else 'any_camera_seen_person'}, f'any camera seen person-{camera_id}': 'true' if any_camera_seen_person else)
